...
Garantir que tout agent IA travaillant sur ce projet applique systématiquement le workflow OpenSpec (création de branche, commits atomiques, sync specs, archive, merge --no-ff).
